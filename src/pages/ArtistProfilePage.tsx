    ...
    <div className="p-8">
      ...
      <div className="mb-8 flex flex-col items-center gap-6 sm:flex-row">
        <Avatar className="h-40 w-40 border-4 border-primary/20">
          ...
          <AvatarFallback className="text-5xl bg-gradient-to-br from-primary to-accent text-white">
        ...
        <div className="text-center sm:text-left">
          ...
          <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground mb-4 sm:justify-start">
