...
import { Heart, Users, LogOut, Sparkles, Loader2, Music, Edit } from 'lucide-react';
...
const ProfilePage: React.FC = () => {
  const { profile, isAuthenticated, isArtist, loading: authLoading, signOut, upgradeToArtist, refreshProfile } = useAuthContext();
      ...
      <div className="mb-6 md:mb-8 flex flex-col items-center gap-4 md:gap-6 sm:flex-row">
        ...
        <div className="text-center sm:text-left">
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-3 sm:justify-start">
            ...
            {!isArtist && (
              <Button onClick={upgradeToArtist} className="gradient-primary glow-primary">
            ...
            <Card className="bg-muted/30 hover:bg-muted/50 transition-colors cursor-pointer">
              <CardContent className="flex items-center gap-4 p-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Playlists and more</p>
                </div>
              </CardContent>
            </Card>
          </Link>
            ...
            <Link to="/dashboard">
              <Card className="bg-muted/30 hover:bg-muted/50 transition-colors cursor-pointer">
                <CardContent className="flex items-center gap-4 p-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Artist Dashboard</h3>
                ...
                <Card className="bg-muted/30 hover:bg-muted/50 transition-colors cursor-pointer">
                  <CardContent className="flex items-center gap-3 p-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-medium">{artist.display_name}</p>
